...
const HomeSection1 = () => {
    return (
        <div className="flex flex-row items-center justify-center w-full md:w-2/3 relative ">
            <div className="flex flex-row  items-center relative w-full max-w-[1200px] mx-auto">
                ...
                <div
                    ...
                    className="w-[90%] md:w-[675px] md:pl-4 text-left text-5xl lg:text-6xl font-bold z-10 absolute right-0  md:right-[20px]">
