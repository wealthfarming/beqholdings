...
const HomeSection2 = () => {
    return (
        <section className="py-8 w-full md:w-[85%] mx-auto md:px-32 px-0 ">
            <div className="flex flex-col items-center justify-center w-full">
                <div className="flex flex-col lg:flex-row md:items-start justify-center w-full mx-auto">
                    <div className="relative lg:w-1/2 w-full h-[50vh] flex items-center justify-center">
                    ...
                    <div className="text-left flex flex-col lg:w-[50%] ml-4 mt-8 lg:mt-0">
