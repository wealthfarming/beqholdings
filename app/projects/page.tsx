                ...
                <div className="flex flex-col md:w-[1260px] w-full md:px-5">
                        ...
                        <div className="flex flex-col max-md:gap-12">
                            <div className="flex md:py-[10px] max-md:flex-col">
                                <Image
                                    ...
                                    width={427}
                                    height={217}
                                    className="p-[10px] md:w-[427px] md:h-[217px]"
                                >
                                </Image>
                                <div className="flex flex-col p-[10px] md:gap-5">
                                    <h2 className="text-[30px] font-bold mb-2">Front End</h2>
                                    <div className="flex flex-col">
                                        <div className="my-4 text-base text-white opacity-75">
                                        ...
                                        <div className="mb-4 text-base text-white opacity-75">
                                    ...
                                    <div className="bg-[#BF9B30] h-[48px] w-[94px] px-4 rounded flex items-center justify-center ">
                                        <div className="text-base font-bold">Website</div>
                                    </div>
                                </div>
                            </div>
                            <div className="flex md:py-[10px] md:mt-10 max-md:flex-col">
                                <Image
                                ...
                                <div className="flex flex-col p-[10px] md:gap-5">
                                    <h2 className="text-[30px] font-bold mb-2">Back End</h2>
                                    <div className="flex flex-col">
                                        <div className="my-4 text-base text-white opacity-75">
                    ...
                    <div className="text-white flex flex-col items-center justify-center p-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex md:py-[10px] md:mt-10 max-md:flex-col">
                                <Image
                                    src={'https://res.cloudinary.com/dyavs1cdn/image/upload/v1752811277/image_2023_06_01T09_58_51_019Z-1536x877_xpq1gv.webp'}
                                    alt=""
                                    width={427}
                                    height={217}
                                    className="p-[10px] md:w-[427px] md:h-[217px]"
                                ...
                                <div className="flex flex-col p-[10px] md:gap-5">
                                    <h2 className="text-[30px] font-bold mb-2">Directory</h2>
                                    <div className="flex flex-col">
                                        <div className="my-4 text-base text-white opacity-75">
